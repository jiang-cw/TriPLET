...
def create_list(data_path):
    ...
    data_list = os.path.join(os.getcwd(),data_path + 'low_dose/')
    data_list = os.listdir(data_list)


    list_all = [{'data': os.path.join(data_path + 'low_dose/', path), 'label': os.path.join(data_path + 'std_dose/', path)} for path in data_list]
