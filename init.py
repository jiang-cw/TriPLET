...
class Options():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--DenNetLR', type=float, default=0.0002, help='learning rate for DenNet')
        parser.add_argument('--RecNetLR', type=float, default=0.0002, help='learning rate for RecNet')
        ...
        parser.add_argument('--DenNetWeights', type=str, default='./checkpoints/d.pth', help="path to generator weights (to continue training)")
        ...
        # basic parameters
        parser.add_argument('--task', type=str, default='internal_test')
        parser.add_argument('--direction', type=str, default='image_to_label', help='image_to_label or label_to_image')
        parser.add_argument('--data_path', type=str, default='./data/2D/DECT/train/')
        parser.add_argument('--val_path', type=str, default='./data/2D/DECT/test/')
